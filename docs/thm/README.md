...
> **💬 Interessado?** [Entre na lista de interesse →](../../issues/new?template=01-escriba-interesse.yml) (2 minutos, sem compromisso)
...
> **💬 Quer acesso antecipado ou avaliar seu RAG jurídico?** [Cadastre seu interesse →](../../issues/new?template=02-jurisbench-submissao.yml)

### 3. hfdownloader — infraestrutura aberta

Este repositório: a ferramenta de download de modelos do HuggingFace usada pela comunidade, que a THM mantém e evolui — incluindo análise de quantizações GGUF, estimativa de RAM e (em desenvolvimento) verificação automática de licenças comerciais.
...
Detalhes, código e limitações: [`docs/thm/jurisbench/`](jurisbench/) · Conjunto de teste oculto: submissões de modelos são bem-vindas via [formulário](../../issues/new?template=02-jurisbench-submissao.yml).
...
- **Interesse no Escriba (transcrição on-premise):** [formulário de 2 minutos](../../issues/new?template=01-escriba-interesse.yml)
- **JurisEmbed-BR / submeter modelo ao benchmark:** [formulário](../../issues/new?template=02-jurisbench-submissao.yml)
