...
Uso (Colab):
  !pip install -q sentence-transformers rank_bm25 datasets pandas pyarrow
...
SEED = 42
N_QUERIES = 500       # ementas usadas como consulta
N_CORPUS = 5000       # acórdãos no corpus de busca (inclui os 500 relevantes)
TOP_K = 10
...
df.to_csv("jurisbench_v0_results.csv", index=False)
with open("jurisbench_v0_results.json", "w") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)
print("\nSalvo em jurisbench_v0_results.{csv,json} — essa tabela é o baseline a bater e o conteúdo do post de lançamento.")
